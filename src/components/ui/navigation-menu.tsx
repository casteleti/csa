...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    {/* Sem Viewport compartilhado: cada Content é posicionado relativo ao
        próprio NavigationMenuItem, evitando que o painel abra alinhado ao
        primeiro item do menu em vez do item que foi clicado. */}
  </NavigationMenuPrimitive.Root>
));
